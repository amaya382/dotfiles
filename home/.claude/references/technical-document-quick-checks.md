# Quick Checks: Language-Independent
...
- [ ] **Paragraph topic (§2).** First sentence of every paragraph reveals its topic, and each paragraph carries one topic?
...
- [ ] **Binary contrasts (§8).** "Not A but B" and "more than just A, it's B" replaced with B stated directly?
